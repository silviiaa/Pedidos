 ...
 */
final class Version20210113110036 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__categoria AS SELECT codCat, nombre, descripcion, Restaurante FROM categoria');
        ...
        $this->addSql('INSERT INTO categoria (codCat, nombre, descripcion, Restaurante) SELECT codCat, nombre, descripcion, Restaurante FROM __temp__categoria');
        ...
        , password VARCHAR(255) NOT NULL COLLATE BINARY, email VARCHAR(180) NOT NULL COLLATE BINARY)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__categoria AS SELECT codCat, nombre, descripcion, Restaurante FROM categoria');
        $this->addSql('DROP TABLE categoria');
        $this->addSql('CREATE TABLE categoria (codCat INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nombre VARCHAR(45) NOT NULL, descripcion VARCHAR(200) NOT NULL, Restaurante INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO categoria (codCat, nombre, descripcion, Restaurante) SELECT codCat, nombre, descripcion, Restaurante FROM __temp__categoria');
        $this->addSql('DROP TABLE __temp__categoria');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_4E10122D3A909126 ON categoria (nombre)');
        $this->addSql('CREATE INDEX IDX_4E10122DDFCB4DA2 ON categoria (Restaurante)');
